...
In case this error is unexpected for you, please report it in https://github.com/prisma/prisma/issues`
    ...
    exports.Prisma.BasketScalarFieldEnum = makeEnum({
      id: "id",
      userId: "userId"
    });
    ...
    exports.Prisma.NumIngredientOnRecipeScalarFieldEnum = makeEnum({
    ...
    exports.Prisma.ModelName = makeEnum({
      ...
      NumIngredientOnRecipe: "NumIngredientOnRecipe",
      Favorite: "Favorite"
    });
...
var getDifficulty = (difficulty) => {
  switch (difficulty) {
    case import_client.Difficulty.DIFFICULT5:
      return 5;
    case import_client.Difficulty.DIFFICULT4:
      return 4;
    case import_client.Difficulty.MODERATE3:
      return 3;
    case import_client.Difficulty.EASY2:
      return 2;
    case import_client.Difficulty.EASY1:
      return 1;
    default:
      return 1;
  }
...
function DifficultyBtn({
  ...
  const [starValue, setStarValue] = (0, import_react.useState)(getDifficulty(difficulty));
  const [clicked, setClicked] = (0, import_react.useState)(0);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
    Array(5).fill("").map((_, idx) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
      "span",
      {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: ` ${isInput ? "text-black" : "text-gray-500"}`, children: starValue.toFixed(1) }, void 0, false, {
      fileName: "app/components/difficulty.tsx",
      lineNumber: 65,
      columnNumber: 7
    }, this)
...
//# sourceMappingURL=/build/_shared/chunk-M42BSJR2.js.map
